...
-	<b>미세먼지 조회</b>
	-	조회 요청 시간과 가장 근접한 시간에 측정한 미세먼지 관련 데이터를 조회 (서비스 타겟이 나의 아내뿐이어서 미세먼지 측정소는 현재 나의 거주지와 가장 가까운 곳(성북구 측정소)으로 하드코딩되어 있음. 어짜피 사용자는 아내밖에 없어서...)<br>
![01.search](http://i.imgur.com/YJezLe2.png)
  <p>

-	<b>가족소개</b>
	-	AWS의 S3를 이용해 가족사진을 표시하도록 함(5장의 사진을 임의로 표시).<br>
![02.family](http://i.imgur.com/1YeL9Dn.png)
  <p>

-	<b>Let's go github...</b>
	-	개발 관련 Github 사이트로 이동.<br>
